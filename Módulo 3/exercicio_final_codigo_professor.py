# Primeiramente, vamos criar a nossa classe no arquivo contato.py.
class Contact:
...
# Logo depois, vamos criar a classe ContactBook, no arquivo contato_agenda.py.
class ContactBook:
    def __init__(self):
        self.contacts = []
...
# Agora vamos criar o nosso programa principal no arquivo exercicio_final.py.
